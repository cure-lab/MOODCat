...
def load_weights(G, D, encoder, state_dict, weights_root, experiment_name,config, epoch_id = 'ep13',
  ...
  root  = "/data/yangyijun/CIFAR10_masking/CIFAR10_osrtask_masked_generator_results/563113_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_CIFAR10_seed99_Gch32_Dch32_bs384_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_Gshared_ema"
