python cifar4_osr_train_cifar10.py --dataset CIFAR10 --parallel --batch_size 192  --which_best FID \
...
--sample_every 2000 --G_eval_mode --id imagenet100_unet_noatt_cutmix_cons --gpus "0,1,2,3" \
...
--base_root ./cifar4_CIFAR10_osrtask_masked_generator_results \
