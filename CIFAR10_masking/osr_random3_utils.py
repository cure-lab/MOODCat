...
def prepare_parser():
  ...
  parser.add_argument("--epoch_id", type=str, default='ep13')
  ...
  parser.add_argument("--progress_bar", action="store_true", default = True)#use progress bar
  ...
  parser.add_argument(
    '--G_batch_size', type=int, default=3,
...
# * Modied by y
def save_weights(G, D, encoder, state_dict, weights_root, experiment_name,
  ...
  torch.save(encoder.module.state_dict(),
              '%s/%s.pth' % (root, join_strings('_', ['E', name_suffix, "ep" , str(state_dict["epoch"])])))
  torch.save(encoder.module.optim.state_dict(),
              '%s/%s.pth' % (root, join_strings('_', ['E_optim', name_suffix, "ep" , str(state_dict["epoch"])])))
...
def load_weights(G, D, encoder, state_dict, weights_root, experiment_name,config, epoch_id = 'ep13',
  ...
  # root = '/data/yangyijun/8_enlargel2advanceGAN/results/40948_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch64_Dch64_bs208_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_ema'
  # root = '/data/yangyijun/8_enlargel2advanceGAN/results/945380_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch64_Dch64_bs184_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_ema'
  # root = "/data/yangyijun/imagenet10/results/975673_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch64_Dch64_bs48_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_ema"
  # root = "/data/yangyijun/imagenet10/unet_generator_results/200701_imagenet10_unet_generator_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch64_Dch64_bs24_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_Gshared_hier_ema"
  # root='/data/yangyijun/imagenet10/unet_generator_results/828764_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch64_Dch64_bs24_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_Gshared_hier_ema'
  # root = '/data/yangyijun/imagenet10/unet_generator_results/305565_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch64_Dch64_bs24_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_Gshared_hier_ema'
  # root = '/data/yangyijun/imagenet10/unet_generator_results/810712_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch32_Dch32_bs96_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_Gshared_ema'
  # root = "/data/yangyijun/imagenet10/unet_generator_results/799726_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch32_Dch32_bs192_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_Gshared_ema"
  # root = "/data/yangyijun/GTSRB_masking/GTSRB_128_erasing_half_masked_unet_generator_results/422167_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_GTSRB_seed99_Gch32_Dch32_bs384_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_Gshared_ema"
  # root = "/data/yangyijun/CIFAR10_masking/CIFAR10_erasing_half_masked_unet_generator_results/630897_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_CIFAR10_seed99_Gch32_Dch32_bs384_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_Gshared_ema"
  root = "/data/yangyijun/CIFAR10_masking/CIFAR10_osrtask_masked_generator_results_random3/920134_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_CIFAR10_seed99_Gch32_Dch32_bs384_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_Gshared_ema"
  #** this enlarge the MSE loss 
  # root = '/data/yangyijun/8_enlargel2advanceGAN/enhanceL2results/348456_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch64_Dch64_bs200_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_ema'
  # root= '/data/yangyijun/8_enlargel2advanceGAN/enhanceL2results/819769_imagenet100_unet_noatt_cutmix_cons/weights/BigGAN_ImageNet_seed99_Gch64_Dch64_bs208_Glr5.0e-05_Dlr2.0e-04_Gnlrelu_Dnlrelu_Ginitortho_Dinitortho_ema'
  ...
  if encoder is not None:
    encoder.load_state_dict(
      torch.load('%s/%s.pth' % (root, join_strings('_', ['E', epoch_id, name_suffix]))))
    if load_optim:
      encoder.optim.load_state_dict(
        torch.load('%s/%s.pth' % (root, join_strings('_', ['E_optim', epoch_id, name_suffix]))))
