...
def run(config):
    ...
    import cifar4_train_fns as train_fns

    config['resolution'] = 32#utils.imsize_dict[config['dataset']]
    print("RESOLUTION: ",config['resolution'])
    # exit()
    config['n_classes'] = 4#utils.nclass_dict[config['dataset']]
...
# TODO: modify the data augmentation part
    if config["dataset"]=="CIFAR10":# imageNet100
        ...
        #* Here we let the known classes num=4 from cifar10, and will let oods from cifar100 [2, 1, 7, 8]
        comb = 'cifar4'
